...
public class DetalheActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagem = (ImageView) findViewById(R.id.moeda_id);
        botaoVoltar = (ImageView) findViewById(R.id.botao_voltar_id);

        Bundle extra = getIntent().getExtras();

        if (extra != null){
            String moedaEscolhida = extra.getString("opcao");
            if (moedaEscolhida.equals("cara")){
